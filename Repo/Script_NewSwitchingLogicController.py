...
import quadcopter
import Controller
from Helpers_Generic import set_fixed_square_path, plot_3d_trajectory, plot_features
...
for ii in range(no_datasets):
    ...
    rotor_mag = 0.30
    att_mag = 1.0
    domain = 4  # 1 LOE 4 Att Noise
    modelname = "Agents/QuadBlendingAgent_MatchPenalty_0_Goal_2000_Easy_1000000"
